...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team play and compete in interscholastic soccer matches",
    ...
    "Swimming Club": {
        ...
        "max_participants": 16,
        "participants": ["alex@mergington.edu", "ella@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        "description": "Acting workshops and production rehearsals for school plays",
